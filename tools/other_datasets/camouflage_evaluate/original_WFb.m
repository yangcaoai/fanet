...
IDXT_GT = IDXT(~GT); %To deal correctly with the edges of the foreground region
save('idxt_gt.mat','IDXT_GT')
Et(~GT)=Et(IDXT_GT); %To deal correctly with the edges of the foreground region
EA = imfilter(Et,K);
MIN_E_EA = E;
