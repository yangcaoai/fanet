...
cfg.DATASET.PATH = 'datasets/Trans10K'
# pixel mean
...
# the prob of flipping images for training
cfg.AUG.FLIP_PROB = 0.5
# rotating images for training
...
cfg.TRAIN.BLOSS_WEIGHT = 5
# some settings related to fake boundary
cfg.TRAIN.FAKE_BOUNDARY_COUNT = 1
cfg.TRAIN.FAKE_BOUNDARY_DISTANCE_ALPHA = 1
cfg.TRAIN.FAKE_BOUNDARY_DISTANCE_BETA = 2
########################### optimizer config ##################################
# base learning rate
cfg.SOLVER.LR = 1e-4
# optimizer method
